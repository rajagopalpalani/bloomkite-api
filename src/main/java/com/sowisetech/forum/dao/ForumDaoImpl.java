...
public class ForumDaoImpl implements ForumDao {
	...
	public int createArticlePost(ArticlePost articlePost, String encryptPass) {
		try {
			...
			String sql = "INSERT INTO `articlepost` (`title`,`url`,`content`,`forumStatusId`,`prodId`,`partyId`,`name`,`designation`,`imagePath`,`created`,`updated`,`delete_flag`,`articleStatusId`,`created_by`,`updated_by`,`userName`,`roleBasedId`) values (?,?,?,?,?,?,AES_ENCRYPT(?,?),?,?,?,?,?,?,?,?,?,?)";
	...
	public int createArticlePostComment(ArticleComment comment, String encryptPass) {
		try {
			...
			ZonedDateTime zdt = ZonedDateTime.now(ZoneId.of("Asia/Calcutta"));
			Timestamp timestamp = Timestamp.valueOf(zdt.toLocalDateTime());
			String sql = "INSERT INTO `articlecomment` (`content`,`forumStatusId`,`partyId`,`parentCommentId`,`name`,`designation`,`imagePath`,`created`,`articleId`,`updated`,`delete_flag`,`created_by`,`updated_by`) values (?,?,?,?,AES_ENCRYPT(?,?),?,?,?,?,?,?,?,?)";
	...
	public List<ArticlePost> fetchRecentArticlePostList(String delete_flag, String encryptPass) {
		try {
			String sql1 = "SELECT `articleId`, `created`, `articleStatusId`, `prodId`, `partyId`, AES_DECRYPT(`name`,?) name,`designation`,`imagePath`,`title`,`content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE `delete_flag` = ? ORDER BY created DESC";
	...
	public ArticlePost fetchRecentApprovedArticle(int forumStatusId, String delete_flag, String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`,`title`, `content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE `forumStatusId` =? AND `delete_flag` = ?  ORDER BY `updated` DESC LIMIT 1";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);
	...
	public List<ArticlePost> fetchAllArticleInApprovedOrder(int forumStatusId, int articleStatusId, String delete_flag,
			String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`, `title`,`content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by`,`userName`,`roleBasedId` FROM `articlepost` WHERE `forumStatusId` =? AND `articleStatusId` =? AND `delete_flag` = ? ORDER BY `updated` DESC";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);
	...
	public List<ArticleComment> fetchArticleCommentByArticleId(long articleId, String deleteflag, String encryptPass) {
		try {
			String sql = "SELECT `commentId`, `parentCommentId`,`created`,`partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`, `content`, `forumStatusId`, `updated`,`articleId`,`adminId`, `delete_flag`,`created_by`,`updated_by` FROM `articlecomment` WHERE `articleId` = ? AND `delete_flag`=? AND `parentCommentId`=? ORDER BY updated DESC";
	...
	public List<ArticlePost> fetchArticlePostList(Pageable pageable, String delete_flag, String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`,`title`, `content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE `delete_flag` = ? ORDER BY created ASC LIMIT "
	...
	public ArticlePost fetchArticlePostByarticleId(long articleId, String delete_flag_N, String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`, AES_DECRYPT(`name`,?) name,`designation`,`imagePath`,`title`,`content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE `articleId` = ? AND `delete_flag` = ?";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);
	...
	public List<ArticlePost> fetchArticleListByPartyId(long partyId, String delete_flag, String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`, AES_DECRYPT(`name`,?) name,`designation`,`imagePath`,`title`,`content`, `forumStatusId`, `updated`, `adminId`,`reason`, `delete_flag`,`articleStatusId`,`created_by`,`updated_by` FROM `articlepost` WHERE `delete_flag` = ? AND `partyId` = ? ORDER BY created DESC";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);
	...
	public String fetchEmailIdByPartyId(long partyId, String delete_flag, String encryptPass) {
		try {
			String sql = "SELECT AES_DECRYPT(`emailId`,?) FROM `party` WHERE `partyId` = ? AND `delete_flag` = ?";
	...
	public List<ArticlePost> fetchArticleListByArticleIdList(List<Long> articleIdList, String delete_flag,
		...
		try {
			...
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`, AES_DECRYPT(`name`,?) name,`designation`,`imagePath`,`title`,`content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE delete_flag =? AND `articleId` IN (%1$s) ORDER BY FIELD(`articleId`,%2$s)";
	...
	public List<ArticleComment> fetchArticleCommentByParentId(long id, long parentId, String delete_flag,
			String encryptPass) {
		try {
			String sql = "SELECT `commentId`, `parentCommentId`,`created`,`partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`, `content`, `forumStatusId`, `updated`,`articleId`,`adminId`, `delete_flag`,`created_by`,`updated_by` FROM `articlecomment` WHERE  `articleId` = ? AND `parentCommentId` = ? AND `delete_flag`=? ORDER BY created ASC";
			RowMapper<ArticleComment> rowMapper = new BeanPropertyRowMapper<ArticleComment>(ArticleComment.class);
	...
	public List<ArticlePost> fetchArticleListByStatusId(Pageable pageable, long forumStatusId, String delete_flag_N,
			String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`, AES_DECRYPT(`name`,?) name, `title`, `designation`,`imagePath`,`content`, `forumStatusId`, `updated`, `adminId`,`reason`, `delete_flag`,`articleStatusId`,`created_by`,`updated_by` FROM `articlepost` WHERE `delete_flag` = ? AND `forumStatusId` = ? ORDER BY updated DESC LIMIT "
					+ pageable.getPageSize() + " OFFSET " + pageable.getOffset() + "";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);
	...
	public List<ArticlePost> searchArticleByTitle(Pageable pageable, String title, String forumStatusId,
		...
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`, AES_DECRYPT(`name`,?) name, `title`,`designation`,`imagePath`,`content`, `forumStatusId`, `updated`, `adminId`,`reason`, `delete_flag`,`articleStatusId`,`created_by`,`updated_by` FROM `articlepost` WHERE `delete_flag` = ? AND `title` LIKE '%"
	...
	public List<ArticlePost> fetchAllArticleInApprovedOrderWithoutToken(int forumStatusId, int articleStatusId,
			String delete_flag, String encryptPass) {
		try {
			String sql = "SELECT `articleId`, `created`, `prodId`, `partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`, `title`,`url`,`content`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE `forumStatusId` =? AND `articleStatusId` =? AND `delete_flag` = ? ORDER BY `updated` DESC LIMIT 10 ";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);
			List<ArticlePost> articlePost = jdbcTemplate.query(sql, rowMapper, encryptPass, forumStatusId,
					articleStatusId, delete_flag);
			return articlePost;
	...
	public List<ArticlePost> fetchAllArticleInApprovedOrderWTByProdId(int prodId, int forumStatusId,
		...
		try {
			String sql = "SELECT `articleId`, `created`, `partyId`,AES_DECRYPT(`name`,?) name,`designation`,`imagePath`, `title`,`url`,`content`,`prodId`, `forumStatusId`, `updated`, `adminId`, `reason`, `delete_flag`,`created_by`,`updated_by` FROM `articlepost` WHERE `prodId` = ? AND `forumStatusId` =? AND `articleStatusId` =? AND `delete_flag` = ? ORDER BY `updated` DESC LIMIT 10 ";
			RowMapper<ArticlePost> rowMapper = new BeanPropertyRowMapper<ArticlePost>(ArticlePost.class);

...
public class ServiceRequestValidator {
	...
	public HashMap<String, HashMap<String, String>> validate( ServiceRequest serviceRequest) {
		...
		if (serviceRequest == null) {
			...
			// }
			if (serviceRequest != null && serviceRequest.getService() != null) {
				error = validateStatus(serviceRequest.getService());
				if (error.isEmpty() == false) {
					allErrors.put("SERVICE", error);
				}
			}
	...
	private HashMap<String, String> validateStatus(String status) {
		String inputParamName = AdminConstants.SERVICE;
